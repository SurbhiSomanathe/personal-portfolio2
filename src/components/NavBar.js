            ...
            <Navbar.Collapse id="basic-navbar-nav">
              ...
              <span className="navbar-text">
                <div className="social-icon">
                  ...
                  <a href="https://drive.google.com/file/d/1aUNp4g_15l08TNs4zIibpHo2L_O1RMtq/view?usp=share_link" target = {"_blank"} rel="noreferrer"><img src={resume} color="white" size="30px" alt="" /></a>       
                </div>                 
              </span>
            </Navbar.Collapse>
          </Container>
